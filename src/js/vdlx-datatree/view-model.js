...
export default function createViewModel(params, componentInfo) {
    ...
    const tableId = get(params, 'tableId', uniqueId('vdlx-datatree-'));
    ...
    $tableDiv.addClass('vdlx-datatree table-striped table-bordered table-condensed');
    $element.append($tableDiv);

    if (!!params.class) {
        $(element).find('.vdlx-datatree').addClass(params.class);
    }
